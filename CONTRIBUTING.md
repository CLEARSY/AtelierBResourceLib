# Contributing to the AtelierBResourceLib library

First off, thank you for considering contributing to the AtelierBResourceLib library!
...
1. **Check if the bug has already been reported** by searching the [issues](https://github.com/CLEARSY/AtelierBResourceLib/issues) page.
...
2. **Identify issue**: Every contribution should correspond to a project [issue](https://github.com/CLEARSY/AtelierBResourceLib/issues). So make sure an issue corresponding to the contribution exists.
